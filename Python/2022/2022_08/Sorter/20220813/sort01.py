...
dstn_dirs = ['Archives', 'Audio', 'Courses', 'DevFiles', 'Documents', 'Export', 'Figma', 'Fonts', 'Form',
 'Illutrator', 'Images', 'Music', 'Other', 'Phone Backup', 'Photoshop', 'Projects', 'Python', 'Raw Data',
  'Sketchup', 'Software', 'Study', 'Video', 'WebFiles']
    ...
    for f_ext, f_list in file_mapping.items():
        if f_ext in EXT_ARCHIVE:
            ...
            for file in f_list:
                ...
                print(f'Files are moved {file} to Documents')
